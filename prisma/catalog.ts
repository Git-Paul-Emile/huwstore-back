...
export const categories: CategorySeed[] = [
  ...
  {
    name: "Pochettes & petite maroquinerie",
    slug: "pochettes-maroquinerie",
    position: 7,
    description: "Portefeuilles et sacs banane, pour ne porter que l'essentiel.",
  },
];
...
export const products: ProductSeed[] = [
  ...
  {
    id: "sac-main-croco-pu",
    slug: "sac-main-croco-pu",
    name: "Sac à main en similicuir PU aspect crocodile",
    collection: "HUWSTORE",
    category: "Cuir PU",
    material: "Similicuir PU aspect crocodile",
    price: 10000,
    badge: "NOUVEAU",
    description:
      "Optez pour ce sac à main au design structuré, idéal pour accompagner vos tenues au quotidien. Léger et pratique, il dispose de longues anses de 26 cm pour un porté confortable à l'épaule ou à la main.",
    care: ENTRETIEN_CUIR_PU,
    widthTopMm: 405,
    widthBottomMm: 315,
    heightMm: 260,
    ...
    features: [
      "Aspect crocodile",
      "Longues anses de 26 cm",
      "Porté main ou épaule",
      "Léger malgré son format",
    ],
    variants: [{ colorName: "Marron", colorSlug: "marron", hex: "#6f4a35" }],
  },
  {
    id: "portefeuille-compact",
    slug: "portefeuille-compact",
    name: "Portefeuille compact",
    collection: "HUWSTORE",
    category: "Pochettes & petite maroquinerie",
    material: "Similicuir",
    price: 3000,
    badge: "NOUVEAU",
    description:
      "Élégant et compact, ce portefeuille est idéal pour garder vos essentiels bien organisés au quotidien. Son format pratique permet de le glisser facilement dans un sac tout en offrant un espace fonctionnel pour vos effets personnels.",
    care: ENTRETIEN_CUIR_PU,
    closure: "Zippée, avec rabat à fermoir",
    widthTopMm: 150,
    heightMm: 90,
    depthMm: 43,
    features: ["Format de poche", "Rabat à fermoir doré", "Compartiments organisés"],
    variants: [
      { colorName: "Noir", colorSlug: "noir", hex: "#1a1a1a" },
      { colorName: "Vert", colorSlug: "vert", hex: "#c3cba4" },
      { colorName: "Rose", colorSlug: "rose", hex: "#efc7cb" },
      { colorName: "Rouge brique", colorSlug: "rouge-brique", hex: "#a8412a" },
    ],
  },
  {
    id: "tote-bag-toile-eco",
    slug: "tote-bag-toile-eco",
    name: "Tote bag cabas en toile éco-responsable",
    collection: "HUWSTORE",
    category: "Toile & Coton",
    material: "Toile de coton de haute qualité",
    price: 8500,
    badge: "NOUVEAU",
    description:
      "Alliez style, simplicité et praticité avec ce sac cabas en toile. Conçu pour s'adapter à votre rythme de vie, il est le compagnon idéal pour le travail, les cours, les courses ou les sorties décontractées. Sa toile premium est robuste et durable, et sa double anse permet un porté main ou épaule.",
    care: ENTRETIEN_TOILE_SANS_TREMPAGE,
    capacity: "Vos essentiels du quotidien",
    widthTopMm: 420,
    widthBottomMm: 320,
    heightMm: 280,
    depthMm: 120,
    ...
    weightGrams: 400,
    features: [
      "Toile premium robuste",
      "Ultra léger",
      "Double anse, porté main ou épaule",
      "Design épuré",
    ],
    variants: [
      { colorName: "Noir thé", colorSlug: "noir-the", hex: "#4a4a48" },
      { colorName: "Blanc crème", colorSlug: "blanc-creme", hex: "#efe6d5" },
      { colorName: "Kaki", colorSlug: "kaki", hex: "#cdb595" },
    ],
  },
  {
    id: "sac-banane-urbain",
    slug: "sac-banane-urbain",
    name: "Sac banane tactique urbain",
    collection: "HUWSTORE",
    category: "Pochettes & petite maroquinerie",
    ...
    badge: "NOUVEAU",
    description:
      "Un sac banane au design épuré et moderne, qui combine une allure urbaine minimaliste et une vraie fonctionnalité. Pour les sorties en ville, le sport ou les voyages, il garde vos essentiels à portée de main : téléphone, clés et papiers.",
    care:
      "Nettoyer avec un chiffon doux légèrement humide. Éviter la machine à laver, l'immersion dans l'eau et les produits agressifs. Sécher à l'air libre.",
    closure: "Zippée, avec tirettes",
    capacity: "Smartphone, clés et papiers",
    widthTopMm: 320,
    widthBottomMm: 190,
    heightMm: 140,
    depthMm: 50,
    features: [
      "Poche principale et poche frontale zippée",
      "Passage pour écouteurs",
      "Sangle ajustable à boucle rapide",
      "Design compact et ergonomique",
    ],
    variants: [{ colorName: "Noir", colorSlug: "noir", hex: "#1a1a1a" }],
  },
  {
    id: "cabas-souple-oxford-pu",
    slug: "cabas-souple-oxford-pu",
    name: "Sac cabas souple en toile Oxford et PU",
    collection: "HUWSTORE",
    category: "Oxford",
    material: "Toile Oxford souple avec finitions en PU",
    price: 9000,
    badge: "NOUVEAU",
    description:
      "Élégant et pratique, ce sac cabas séduit par son design sobre et ses finitions soignées. Son corps en toile Oxford souple offre un rendu léger et confortable, tandis que les détails en PU apportent une touche élégante et structurée. Son format permet de transporter facilement vos essentiels du quotidien ainsi que des documents au format A4 ou une tablette. Il se porte à l'épaule grâce à ses anses, pour un usage pratique au quotidien.",
    care: ENTRETIEN_CUIR_PU,
    closure: "À rabat avec boucle",
    capacity: "Documents A4 ou tablette",
    widthTopMm: 410,
    widthBottomMm: 320,
    heightMm: 260,
    depthMm: 160,
    ...
    weightGrams: 300,
    features: [
      "Toile Oxford souple, finitions en PU",
      "Fermeture à rabat avec boucle",
      "Porté épaule, anses de 56 cm",
      "Accueille documents A4 et tablette",
    ],
    variants: [
      { colorName: "Noir", colorSlug: "noir", hex: "#1a1a1a" },
      { colorName: "Marron", colorSlug: "marron", hex: "#a97f52" },
    ],
  },
  {
    id: "tote-bag-multifonction",
    slug: "tote-bag-multifonction",
    name: "Tote bag multifonction",
    collection: "HUWSTORE",
    category: "Toile & Coton",
    material: "Toile",
    price: 4000,
    badge: "NOUVEAU",
    description:
      "Pratique et polyvalent, ce tote bag en toile est idéal pour accompagner vos déplacements au quotidien. Son design fonctionnel permet de le porter à la main, à l'épaule, en bandoulière ou en sac à dos. Son format permet de ranger facilement vos essentiels, notamment des documents A4, des livres ou une bouteille d'eau. Il dispose également d'une fermeture zippée pour garder vos affaires bien protégées.",
    care: ENTRETIEN_TOILE,
    closure: "Zippée",
    capacity: "Documents A4, livres, bouteille d'eau",
    widthTopMm: 300,
    heightMm: 320,
    depthMm: 40,
    features: [
      "Quatre ports : main, épaule, bandoulière et sac à dos",
      "Fermeture zippée",
    ...
    variants: [
      { colorName: "Noir", colorSlug: "noir", hex: "#1a1a1a" },
      { colorName: "Blanc", colorSlug: "blanc", hex: "#f2f0eb" },
      { colorName: "Jaune", colorSlug: "jaune", hex: "#f0c419" },
      { colorName: "Rose", colorSlug: "rose", hex: "#f0a8bd" },
    ],
  },
  {
    id: "tote-bag-run-alone",
    slug: "tote-bag-run-alone",
    name: "Tote bag Run Alone",
    collection: "HUWSTORE",
    category: "Toile & Coton",
    material: "Toile",
    price: 6000,
    badge: "NOUVEAU",
    description:
      "Pratique et tendance, ce tote bag en toile séduit par son design bicolore et son format spacieux. Il dispose d'une fermeture zippée et de longues anses offrant un porté confortable. Idéal pour les sorties, les courses, les études ou le quotidien.",
    care: ENTRETIEN_TOILE,
    closure: "Zippée",
    capacity: "Vos essentiels du quotidien",
    widthTopMm: 400,
    ...
    features: [
      "Design bicolore",
      "Fermeture zippée",
      "Longues anses, porté épaule",
      "Format spacieux",
    ],
    variants: [
      { colorName: "Noir", colorSlug: "noir", hex: "#1a1a1a", hexSecondary: "#ece3d4" },
      { colorName: "Vert", colorSlug: "vert", hex: "#2f5c4c", hexSecondary: "#ece3d4" },
    ],
  },
  {
    id: "sac-main-cuir-pu",
    slug: "sac-main-cuir-pu",
    name: "Sac à main en cuir polyuréthane",
    collection: "HUWSTORE",
    category: "Cuir PU",
    material: "Similicuir (PU)",
    price: 10000,
    badge: "NOUVEAU",
    description:
      "Un sac à main en similicuir à la ligne épurée, conçu pour un usage quotidien léger. Sa fermeture zippée garde vos affaires à l'abri et ses longues anses permettent un porté épaule confortable. Ce modèle est destiné à un usage léger : il est déconseillé d'y mettre des cahiers, un ordinateur ou des objets lourds, afin de préserver les anses et leur fixation.",
    care: ENTRETIEN_CUIR_PU,
    closure: "Zippée",
    capacity: "Usage léger, sans ordinateur",
    widthTopMm: 435,
    widthBottomMm: 315,
    heightMm: 265,
    depthMm: 115,
    ...
    weightGrams: 380,
    features: [
      "Similicuir souple, finition mate",
      "Fermeture zippée",
      "Poche intérieure zippée",
      "Porté épaule, anses de 26 cm",
    ],
    variants: [
      { colorName: "Noir", colorSlug: "noir", hex: "#1a1a1a" },
      { colorName: "Marron", colorSlug: "marron", hex: "#6b4a37" },
    ],
  },
];
