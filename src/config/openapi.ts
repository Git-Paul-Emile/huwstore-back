  ...
  paths: {
    ...
    "/banners": {
      get: {
        ...
        parameters: [
          { name: "slot", in: "query", schema: { type: "string", enum: ["Bandeau promo"] } },
        ],
    ...
    schemas: {
      ...
      Banner: {
        ...
        properties: {
          ...
          linkType: { type: "string", enum: ["Page libre", "Catégorie", "Produit"] },
          linkCategoryId: { type: "string" },
          linkProductId: { type: "string" },
          ctaHref: { type: "string", description: "Chemin interne calculé par le serveur d'après la destination choisie." },
          slot: { type: "string", enum: ["Bandeau promo"] },
